    ...
    <div className="bg-background min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <main className="relative z-10 w-full max-w-[440px] px-container-padding">
        ...
        <div className="bg-surface/80 backdrop-blur-xl border border-surface-container-lowest/50 rounded-xl shadow-2xl p-8 flex flex-col gap-8">
          ...
          <div className="text-center flex flex-col items-center gap-2">
            <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-2 shadow-sm overflow-hidden bg-white/50 backdrop-blur-md border border-white/20 p-2">
              <img src="/logo.png" alt="STIBAJRA Pay Logo" className="w-full h-full object-contain drop-shadow-md" onError={(e) => { e.target.style.display = 'none'; e.target.nextSibling.style.display = 'block'; }} />
              <span className="material-symbols-outlined text-primary hidden" style={{ fontSize: '32px' }}>account_balance</span>
            </div>
            <h1 className="font-headline-lg text-headline-lg text-primary m-0">STIBAJRA Pay</h1>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative flex items-center">
                ...
                <input 
                  ...
                  id="email" 
                  placeholder={role === 'student' ? 'Masukkan NISN' : 'admin@stibajrapay.com'} 
                  type="text"
                  value={email}
        ...
        <div className="mt-8 text-center">
          <p className="font-label-md text-label-md text-surface-container-lowest/80">© 2024 STIBAJRA Pay. Secure Financial Gateway.</p>
        </div>
      </main>
    </div>
  );
